...
#define INPUT_1 GPIO_NUM_5
#define INPUT_2 GPIO_NUM_18

#define ENABLE_ESQ ENABLE_A

#define ENABLE_B GPIO_NUM_33
#define INPUT_3 GPIO_NUM_4
...
#define MAX_INTEGRAL_VALUE 500.0
...
#define PCNT_CHB_LEFT 25

#define PCNT_CHA_RIGHT 27
#define PCNT_CHB_RIGHT 14

#define PI 3.14159

#define ENCODER_RESOLUTION_TICKS 1320
#define ENCODER_COUNTER_WAIT_PID_OP  1//10  //number of pid operations required to extrac encoder speed
